...
web_app_callbacks           = ["$(PLATFORM_CONTAINER_WEB_APP_NAME)/callback", "https://localhost:7200/callback", "http://localhost:5200/callback"]
web_app_allowed_logout_urls = ["$(PLATFORM_CONTAINER_WEB_APP_NAME)"]
web_app_web_origins         = ["$(PLATFORM_CONTAINER_WEB_APP_NAME)", "https://localhost:7200", "http://localhost:5200"]
